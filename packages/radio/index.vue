<template>
  <div class="ivc-radio">
    <input type="radio" v-model="currentRadio" :value="text"  :name="name" :disabled="disabled || !ifClick" @change="changeCheck" class="ivc-radio-input">
    <span :class="['ivc-radio-button', {'disabled': disabled}]"></span>
  </div>
</template>
<script>
  export default {
